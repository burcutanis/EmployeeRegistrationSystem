...
function Add(props) {
    ...
    const { values, handleChange, addExperienceFields, removeExFields } = props;
    return (
        ...
        <>
            ...
            <Form onSubmit={continuefnc} >
                {values.experienceItems.map((experienceItem, index) => (
                    <div id="container" className="educationDiv">
                        <header className="head-form">
                            ...
                            <p> If you have job experience, start with your present or most recent employment and work back. </p>
                        ...
                        <Form.Group className="mb-3" >
                            ...
                            <Form.Control
                                type="text"
                                placeholder="Enter your duties in the company"
