...
function EditPersonalInfo() {
    ...
    useEffect(() => {
        const FetchData = async () => {
            axios.get(`http://localhost:4000/personalInformation/user/${searchParams.get("id")}`)
                .then(result => {
    ...
    function updateUser() {
        axios.put(`http://localhost:4000/personalInformation/${id}`, {
            "dateOfBirth": dateOfBirth,
            "maritalStatus": maritalStatus, "address":
                address, "city": city, "mobile": mobile,
            "gender": gender
        })
            .then(res => {
                console.log(res);
